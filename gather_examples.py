...
# python gather_examples.py --input fake1.mov --output dataset/fake --detector face_detector --skip 4
# python gather_examples.py --input videos/real1.mov --output dataset/real --detector face_detector --skip 1
